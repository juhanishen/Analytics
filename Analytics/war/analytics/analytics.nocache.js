...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "analytics" because\n';
  ...
  $wnd.__gwt_activeModules['analytics'] = {
 ...
 * "/analytics.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['analytics'].superdevmode = true;

  var expectedSuffix = '/analytics.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + analytics + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:analytics';
  var devModeSessionKey = '__gwtDevModeSession:analytics';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/analytics/analytics.nocache.js';
  ...
  $wnd.__gwt_activeModules['analytics'].canRedirect = true;
  $wnd.__gwt_activeModules['analytics'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/analytics?user.agent=' + ua + '&_callback=' + callback;
