...
class Handler implements Runnable {
	...
	public Handler(SolrServer solr, List<String> lines) {
	...
	public void run() {
		for(String line:lines){
			...
			document.addField( ZXGJParserHelper.IDField, String.valueOf(ZXGJParserHelper.idGenerator.getAndIncrement()));
