 ...
 */
public class AnalyticsOld implements EntryPoint {
	/**
	...
	// event table 1: begin
		...
		// comment table 1: begin
		    ...
		    // knowledge Engineering table 1: starts
			...
			// knowledge Engineering table 1: ends  
...
//				RootPanel.get("searchTimeScaleContainer").add(searchChart);
			
		//search highcharts code are here: end:   
         ...
         // knowledge engineering table 2: starts
		 // Create a CellTable.
	 	...
	 	// Create address column.
	 	 ...
	 	 knowledgeTable.getColumnSortList().push(knowledgeReasonColumn);
		    ...
		    RootPanel.get("knowledgeEngineeringContainer").add(knowledgeTable);	 
		 
		 // knowledge engineering table 2: ends     
	...
	public Chart createSearchChart(){
        final Chart chart = new Chart()  
        .setZoomType(Chart.ZoomType.X)  
        .setSpacingRight(20)  
        .setChartTitle(new ChartTitle()  
